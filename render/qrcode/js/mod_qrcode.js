...
baidu.qrcode = (function() {
  ...
  var f = function() {
    chrome.runtime.onMessage.addListener(function(i, h, j) {
      if (i.type == MSG_TYPE.TAB_CREATED_OR_UPDATED && i.event == "qrcode") {
        if (i.content) {
          document.getElementById("codeSource").value = i.content;
          setTimeout(b, 50);
        }
      }
    });
